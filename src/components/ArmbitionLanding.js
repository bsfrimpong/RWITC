    ...
    <div className="min-h-screen bg-orange-50 font-nunito">
      ...
      >
        ...
        <div className="absolute inset-0 opacity-10">
          {[...Array(20)].map((_, i) => (
            ...
            >
              {[<Code />, <Cpu />, <Wrench />, <Smartphone />][i % 4]}
            </motion.div>
          ))}
        </div>
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          <motion.div
            ...
            className="bg-white bg-opacity-15 backdrop-blur-lg rounded-3xl p-8 mb-8 border border-white border-opacity-20"
          >
            <h1 className="text-7xl font-black mb-4 text-white">
              ARM<span className="text-yellow-300">BITION</span>
            </h1>
            <p className="text-2xl font-bold text-orange-100 mb-2">Summer Innovation School</p>
            <p className="text-lg text-orange-200">Building Tomorrow's Solutions Today</p>
          </motion.div>
          ...
          <motion.p 
            className="text-xl text-white max-w-4xl mx-auto mb-8 leading-relaxed"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            {[
              ...
              <div key={index} className="bg-white bg-opacity-20 backdrop-blur-lg rounded-2xl p-6 border border-white border-opacity-30">
          ...
          >
            <button 
              ...
              className="bg-white text-orange-600 hover:bg-orange-50 font-bold py-4 px-8 rounded-full text-lg transition duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              Secure Your Child's Spot
            </button>
            <a href="#projects" className="border-2 border-white text-white hover:bg-white hover:text-orange-600 font-bold py-4 px-8 rounded-full text-lg transition duration-300">
          ...
          {formSubmitted && (
            <motion.div 
              className="mt-6 bg-yellow-100 text-yellow-800 p-4 rounded-lg max-w-md mx-auto"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            >
              <p className="font-semibold">Important:</p>
              <p>Your registration will only be processed after payment of the GH₵50 registration fee.</p>
            </motion.div>
          )}
        </div>
      </motion.header>
      ...
      <section className="py-20 bg-gradient-to-r from-yellow-100 to-orange-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-black text-orange-800 mb-6">
              The Pride Every Parent Deserves
            </h2>
            <p className="text-xl text-orange-700 max-w-4xl mx-auto leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-orange-700 max-w-4xl mx-auto mb-8">
            ...
            <div className="bg-green-100 border border-green-300 rounded-2xl p-6 max-w-2xl mx-auto">
              <p className="text-green-800 font-bold text-lg mb-2">Proven Track Record</p>
              <p className="text-green-700">9 real projects built by students just like yours, now making actual impact in communities across Ghana.</p>
            </div>
          </div>

          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h3 className="text-3xl font-bold text-orange-800 mb-6">Real Students, Real Projects, Real Impact</h3>
              <div className="space-y-6">
                <div className="bg-orange-50 rounded-xl p-6">
                  <h4 className="font-bold text-orange-800 mb-3">Schools Already Trained</h4>
                  <p className="text-orange-700">Multiple schools across Ghana have successfully completed our program, with students building functioning prototypes that address real community challenges.</p>
                </div>
                
                <div className="bg-blue-50 rounded-xl p-6">
                  <h4 className="font-bold text-blue-800 mb-3">9 Projects Completed</h4>
                  <p className="text-blue-700">From solar charging stations to waste management systems, our students have proven that young minds can create solutions that work.</p>
                </div>
                
                <div className="bg-green-50 rounded-xl p-6">
                  <h4 className="font-bold text-green-800 mb-3">Community Deployment</h4>
                  <p className="text-green-700">These aren't school experiments - they're real solutions being used by real people in real communities right now.</p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-8 text-white shadow-2xl">
                <div className="h-48 bg-white/20 rounded-xl mb-4 flex items-center justify-center">
                  <PlayCircle className="h-16 w-16" />
                </div>
                <h3 className="text-2xl font-bold mb-4">Watch Student Success Stories</h3>
                ...
                <a
                  ...
                  className="bg-white text-orange-600 hover:bg-orange-50 font-bold py-4 px-8 rounded-full text-lg transition duration-300 inline-flex items-center shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  <PlayCircle className="mr-2 h-6 w-6" />
                  Watch on YouTube
                </a>
                <p className="text-orange-200 text-sm mt-4">9 project videos available now</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-900 rounded-3xl p-8 text-white">
            <h3 className="text-3xl font-bold text-center mb-8">Project Highlights</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={index} className="bg-gray-800 rounded-xl p-6 hover:bg-gray-700 transition-colors duration-300">
                  ...
                  <h4 className="font-bold text-white mb-3 text-center">{video.title}</h4>
                  <p className="text-gray-300 text-sm text-center mb-4">{video.description}</p>
            ...
            <div className="text-center mt-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-8 rounded-full text-lg transition duration-300 inline-flex items-center"
              >
          ...
          {/* Testimonial from completed program */}
          <div className="mt-16 bg-orange-50 rounded-3xl p-8">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-orange-800 mb-6">What Parents Are Saying</h3>
              <div className="max-w-3xl mx-auto">
                <p className="text-xl text-orange-700 italic mb-6">
                ...
                <div className="flex items-center justify-center space-x-4">
                  ...
                  <div className="text-left">
                    <p className="font-bold text-orange-800">Mrs. Akosua Mensah</p>
                    <p className="text-orange-600">Parent of Armbition Graduate</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="projects" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-orange-700 max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            {projects.map((project, index) => (
              <motion.div
                key={project.id}
                className="bg-gradient-to-r from-white to-orange-50 rounded-3xl shadow-xl overflow-hidden"
                  ...
                  <div className="grid md:grid-cols-3 gap-8 items-center">
                    <div className="text-center md:text-left">
                      ...
                      <button
                        ...
                        className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-full transition duration-300 inline-flex items-center"
                      >
                        {activeProject === project.id ? 'Hide Details' : 'View Details'}
                        <ChevronDown className={`ml-2 h-5 w-5 transform transition-transform ${activeProject === project.id ? 'rotate-180' : ''}`} />
                      </button>
                    </div>
                    ...
                    <div className="md:col-span-2">
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <h4 className="font-bold text-orange-800 mb-3">Skills Learned:</h4>
                          <div className="space-y-2">
                            {project.skills.map((skill, idx) => (
                              <div key={idx} className="bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-sm">
                                {skill}
                              </div>
                            ))}
                          </div>
                        ...
                        <div>
                          <h4 className="font-bold text-orange-800 mb-3">Community Impact:</h4>
                  ...
                  <AnimatePresence>
                    {activeProject === project.id && (
                      <motion.div
                        ...
                        className="mt-8 border-t border-orange-200 pt-8"
                      >
                        <h4 className="font-bold text-orange-800 mb-4 text-xl">Project Features:</h4>
      ...
      <section className="py-20 bg-orange-50">
        <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="md:w-1/3">
                    <div className="bg-white rounded-3xl p-8 shadow-xl text-center">
                      <div className="text-4xl font-black text-orange-500 mb-2">{week.week}</div>
                      <h3 className="text-xl font-bold text-orange-800">{week.title}</h3>
                    </div>
                  </div>
                      ...
                      {week.activities.map((activity, idx) => (
                        <div key={idx} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                          <div className="flex items-center space-x-3">
                            ...
                            <span className="text-orange-700 font-semibold">{activity}</span>
                          </div>
                        </div>
                      ))}
                    </div>
          ...
          <div className="mt-16 bg-white rounded-3xl p-8 shadow-xl">
            <h3 className="text-2xl font-bold text-orange-800 mb-6 text-center">Daily Schedule (10:30 AM - 3:30 PM)</h3>
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              {[
                ...
                <div key={index} className="bg-orange-50 rounded-xl p-4 text-center">
                  <div className="font-bold text-orange-800 text-sm mb-2">{slot.time}</div>
                  <div className="text-orange-700 text-sm">{slot.activity}</div>
                </div>
              ))}
            </div>
            <p className="text-center text-orange-600 mt-4 font-semibold">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {locations.map((location, index) => (
              <motion.div
                key={index}
                className="bg-gradient-to-br from-orange-50 to-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
              ...
              >
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-orange-800">{location.name}</h3>
                </div>
                <p className="text-orange-700 font-semibold mb-2">{location.venue}</p>
                <p className="text-orange-600 mb-4">{location.address}</p>
                <div className="bg-orange-100 rounded-xl p-4">
                  <p className="text-orange-800 text-sm font-semibold">30 students per center</p>
                  <p className="text-orange-800 text-sm font-semibold">Industry-standard equipment</p>
                  <p className="text-orange-800 text-sm font-semibold">8 professional mentors</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
              ...
              <div className="p-12 text-center">
                <div className="text-6xl font-black text-orange-600 mb-4">GH₵ 1,500</div>
                <p className="text-xl text-orange-700 mb-8">Complete 3-Week Transformation Package</p>
                ...
                <div className="bg-red-100 border border-red-300 rounded-xl p-6 mb-8">
                  <p className="text-red-800 font-bold text-xl mb-2">LIMITED: Only 30 spots per center</p>
                  <p className="text-red-700">Registration fills up fast - secure your child's future today!</p>
                </div>

                <div className="space-y-4 mb-8">
                  <p className="text-orange-700 font-semibold">Early Bird: 15% discount available</p>
                  <p className="text-orange-700 font-semibold">Payment Plan: GH₵ 50 registration + flexible installments</p>
                </div>

                <div className="flex flex-col md:flex-row gap-4 justify-center">
                  <button
                    onClick={handleRegistration}
                    className="bg-orange-600 hover:bg-orange-700 text-white font-bold py-4 px-8 rounded-full text-lg transition duration-300 inline-flex items-center justify-center"
                  >
                  ...
                  <a
                    ...
                    className="border-2 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white font-bold py-4 px-8 rounded-full text-lg transition duration-300 inline-flex items-center justify-center"
                  >
                ...
                <div className="mt-6 bg-yellow-100 text-yellow-800 p-4 rounded-lg">
                  <p className="font-semibold">Important Registration Note:</p>
                  <p>Your registration will only be processed after payment of the GH₵50 registration fee.</p>
                </div>
              </div>
            </div>
            ...
            {[
              ...
              >
                ...
                <div className="bg-orange-100 p-3 rounded-xl">
                  <p className="text-orange-800 text-sm font-semibold text-center">
                    {item.highlight}
                  </p>
                </div>
              </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center bg-orange-600 rounded-3xl p-8">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <button
                onClick={handleRegistration}
                className="bg-white text-orange-600 hover:bg-orange-50 font-bold py-4 px-8 rounded-full text-lg transition duration-300 inline-flex items-center justify-center"
              >
                <Send className="mr-2 h-5 w-5" />
                Register Now
              </button>
              <a
                href="tel:+233246756644"
                className="border-2 border-white text-white hover:bg-white hover:text-orange-600 font-bold py-4 px-8 rounded-full text-lg transition duration-300 inline-flex items-center justify-center"
              >
                <Phone className="mr-2 h-5 w-5" />
                Call: 0246756644
              </a>
            ...
            <div className="mt-6 bg-white/20 rounded-lg p-4 max-w-md mx-auto">
              <p className="text-orange-100 font-semibold">Note: Registration requires GH₵50 fee payment to be processed</p>
            </div>
          </div>
        </div>
      </section>
